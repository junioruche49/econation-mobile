...
function Inventory() {
  ...
  const handeleNewSorter = () => {
    navigation.navigate("NewSorter");
  };
  const handeleSortingOperation = () => {
    navigation.navigate("Sorter");
  };
  return (
      ...
      <ScrollView>
        ...
        <HomeBg title={"Inventory"}>
          <View style={styles.headerIcons}>
            ...
            <TouchableOpacity
              onPress={handeleNewSorter}
              style={styles.headerIcon}
            >
              <Image source={SO} style={styles.icon} />
              <Text style={styles.iconText}>New Sorter</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={handeleSortingOperation}
              style={styles.headerIcon}
            >
              <Image source={HO} style={styles.icon} />
              <Text style={styles.iconText}>Sorting Operation</Text>
            </TouchableOpacity>
          </View>
        </HomeBg>
